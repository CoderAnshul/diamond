        ...
        <div className="relative z-10 flex items-center justify-center h-[400px] w-full ">
          <div className="text-center text-white">
            ...
            <p className="text-sm md:text-sm max-w-lg lg:text-sm font-normal">
              Our stylish pendants are a stunning addition to any outfit. Exquisitely crafted with meticulous attention to detail, our pendants are the perfect gift for any special occasion.
            </p>
          </div>
        </div>
      </div>
