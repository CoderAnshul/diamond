    ...
    <div>
      <div className="relative h-[400px] w-full">
        ...
        <div className="absolute inset-0">
          <img 
            src="https://cdn.shopify.com/s/files/1/0644/3067/0060/files/Banner-Earring-Hero-Website_1_2000x2000.jpg?v=1696554630"
        ...
        <div className="relative z-10 flex items-center justify-center h-[400px] w-full ">
          <div className="text-center text-white">
            ...
            <p className="text-sm md:text-sm lg:text-sm max-w-xl font-normal">
              Whether you're searching for yourself or for a special someone in your life, our range of beautiful earrings are sure to suit every taste.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-50 py-8 px-4">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center">
            <button className="bg px-8 py-3 border bg-[#346441] text-gray-700 hover:bg-[#25462E] transition-colors duration-200 font-medium tracking-wide">
              LOAD MORE
            </button>
          </div>
        </div>
